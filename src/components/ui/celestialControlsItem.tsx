            ...
            {props.entity instanceof Celestial && <>
                <div className="header">
                    ...
                    <div className="buttons">
                        {(props.entity.satellites.length > 0) && (<button className="toggle" onClick={() => setCollapsed(!collapsed)}>
                        ...
                        {(props.entity.sequence.length > 1) && <button className="delete" onClick={() => props.deleteEntity(props.entity.sequence)}>
                        ...
                        {(props.entity.sequence.length < 8) && <button className="add" onClick={() => props.addEntity(props.entity.sequence)}>
